...
function SingleProduct() {
    ...
    <div className="container w-[100%] mx-auto px-4 space-y-8 ">
      ...
      <nav className="bg-[#F9F1E7] py-12 w-full mb-8 ">
        <div className="flex items-center space-x-8 ">
          <Link href="/" className="text-[#9F9F9F] hover:underline flex items-center text-xl">
          ...
          <Link href="/" className="text-xl font-semibold"> Asgaard Sofa</Link>
        </div>
      </nav>
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 w-full md:w-1/2">
          ...
          <p className="text-gray-700 mb-4 pb-3">
            Setting the bar as one of the loudest speakers and its class the <br />
            Killburn is a compact stout-hearted hero with a well-balanced<br />
          ...
          <div className="flex gap-4 mb-4">
            ...
            <Link href="/" className="text-[#9F9F9F] hover:bg-yellow-600 flex items-center text-xl">
                <Image src="/Image_27.png" height={30} width={30} alt="pic90" /> </Link>
            <Link href="/" className="text-[#9F9F9F] hover:bg-yellow-600 flex items-center text-xl">
                <Image src="/Image_28.png" height={30} width={30} alt="pic90" /> </Link>
                <Link href="/" className="text-[#9F9F9F] hover:bg-yellow-600 flex items-center text-xl">
                <Image src="/Image-29.png" height={30} width={30} alt="pic90" /> </Link>
              </div>
            </div>
            ...
            <div className="space-y-2 pb-4">
              ...
              <div className="flex space-x-2">
              <Link href="/" className="text-[#9F9F9F] flex items-center text-xl">
                <Image src="/Image_30.png" height={30} width={30} alt="pic90" /> </Link>
               <Link href="/" className="text-[#9F9F9F] flex items-center text-xl">
                <Image src="/Image_31.png" height={30} width={30} alt="pic90" /> </Link>
               <Link href="/" className="text-[#9F9F9F] flex items-center text-xl">
                <Image src="/Image_32.png" height={30} width={30} alt="pic90" /> </Link>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-center pb-10">
            ...
            <Link href="/compairision" className="text-[#9F9F9F] flex items-center text-xl">
            <button className="px-6 py-2 bg-gray-100 text-black border border-black rounded hover:bg-gray-300">
              + Compare
            </button>
            </Link>
  ...
  />
      ...
      <div className="mt-12">
        ...
        <Link href="/singleproduct/id" className="text-[#9F9F9F] flex items-center text-xl">
          <div className="border rounded-lg p-4 shadow-md space-y-2">
            <Image src="/Image_06.png" width={385} height={351} alt="Chair" className="w-full h-[301px] mb-2 rounded-lg" />
          ...
          <Link href="/singleproduct/id" className="text-[#9F9F9F] flex items-center text-xl">
          <div className="border rounded-lg p-4 shadow-md space-y-2">
            <Image src="/image_21.png" width={385} height={351} alt="Chair" className="w-full h-[301px] mb-2 rounded-lg" />
          ...
          <Link href="/singleproduct/id" className="text-[#9F9F9F] flex items-center text-xl">
          <div className="border rounded-lg p-4 shadow-md space-y-2">
            <Image src="/Image_08.png" width={385} height={351} alt="Sofa" className="w-full h-[301px] mb-2 rounded-lg" />
          ...
          <Link href="/singleproduct/id" className="text-[#9F9F9F] flex items-center text-xl">
          <div className="border rounded-lg p-4 shadow-md space-y-2">
            <img src="/Image_09.png" width={385} height={351} alt="Sofa" className="w-full h-[277px] mb-2 rounded-lg" />
