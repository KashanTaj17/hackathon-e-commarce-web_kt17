        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <label className="block text-black font-medium mb-1 ">
                  ...
                  <input
                    type="text"
                    placeholder=""
                    className="w-[211px] border border-[#9F9F9F] p-3 rounded-md focus:ring-2 focus:ring-yellow-700 focus:outline-none"
                  />{" "}
                </label>
              ...
              <label className="block text-black font-medium mb-1 ">
                Company Name (Optional) <br></br> <br></br>
                <input
                  type="text"
                  placeholder=""
                  className="w-[453px] border border-[#9F9F9F] p-3 rounded-md focus:ring-2 focus:ring-yellow-700 focus:outline-none"
                />{" "}
              </label>

              <label className="block text-black font-medium mb-1 ">
                Country / Region <br></br> <br></br>
                <input
                  type="text"
              ...
              <label className="block text-black font-medium mb-1 ">
                Province <br></br> <br></br>
                <input
                  type="text"
                  placeholder="Wastern Province"
                  className="w-[453px] border border-[#9F9F9F] p-3 rounded-md focus:ring-2 focus:ring-yellow-700 focus:outline-none"
                />{" "}
              </label>

              <label className="block text-black font-medium mb-1 ">
                ZIP Code <br></br> <br></br>
                <input
                  type="text"
                  placeholder="Wastern Province"
                  className="w-[453px] border border-[#9F9F9F] p-3 rounded-md focus:ring-2 focus:ring-yellow-700 focus:outline-none"
